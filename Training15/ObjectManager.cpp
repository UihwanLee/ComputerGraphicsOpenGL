...
GLvoid InitObjectStruct(ObjectInfo* objInfo, int num_ver, int sp, int si, int drawType, float pivotX, float pivotY, bool modeIDX, bool isAinm, bool isActive)
{
...
void ObjectManager::CreateCoordinate()
{
	...
	InitObjectStruct(&temp, 4, 48, 0, GL_LINES, 0.f, 0.f, false, false, true);
...
void ObjectManager::CreateCube()
{
	...
	InitObjectStruct(&temp, 36, 96, 144, GL_TRIANGLES, 0.f, 0.f, true, false, true);
...
void ObjectManager::CreateTetrahedron()
{
	...
	InitObjectStruct(&temp, 12, 48, 48, GL_TRIANGLES, 0.f, 0.f, true, false, true);
...
void ObjectManager::CreateSquarePyramid()
{
	...
	InitObjectStruct(&temp, 18, 72, 72, GL_TRIANGLES, 0.f, 0.f, true, false, true);

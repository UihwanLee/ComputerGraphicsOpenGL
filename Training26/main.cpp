...
GLvoid Reset()
{
	...
	ObjMgr.SetScale(0, 0.03f, 0.03f, 0.03f);

	ObjMgr.CreateSqhere(0.0f, 1.0f, 0.0f);
	ObjMgr.SetScale(1, 0.02f, 0.02f, 0.02f);
	ObjMgr.SetPosition(1, -8.0f, 0.0f, 0.0f);

	ObjMgr.CreateSqhere(0.0f, 0.0f, 1.0f);
	ObjMgr.SetScale(2, 0.01f, 0.01f, 0.01f);
	ObjMgr.SetPosition(2, -30.0f, 0.0f, 0.0f);

	ObjMgr.CreateSmallCube(128.0f/255.0f, 128.0f / 255.0f, 128.0f / 255.0f);
	ObjMgr.SetPosition(3, LightPos.x, LightPos.y, LightPos.z);

	CameraPos = glm::vec3(0.0f, 0.3f, 1.0f);
}
